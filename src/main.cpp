...
int64 nChainStartTime = 1399716533;
...
const string strMessageMagic = "Colorcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Colorcoin
    bool fStrictPayToScriptHash = true; // Always active in Colorcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Colorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Colorcoin to the MOOOOOOOOOON!";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1399716533;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 7602765 ;
        if (false ) {
        ...
        assert(block.hashMerkleRoot == uint256("0be6acf460e0c9cb67d08f683ee88e8cd17990e59e77e1e31fb197efac99d00f"));
